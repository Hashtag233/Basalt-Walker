...
public class MeltingSoftBasalt2UpdateTickProcedure extends BasaltWalkerModElements.ModElement {
	public MeltingSoftBasalt2UpdateTickProcedure(BasaltWalkerModElements instance) {
		super(instance, 9);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BasaltWalkerMod.LOGGER.warn("Failed to load dependency x for procedure MeltingSoftBasalt2UpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BasaltWalkerMod.LOGGER.warn("Failed to load dependency y for procedure MeltingSoftBasalt2UpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BasaltWalkerMod.LOGGER.warn("Failed to load dependency z for procedure MeltingSoftBasalt2UpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BasaltWalkerMod.LOGGER.warn("Failed to load dependency world for procedure MeltingSoftBasalt2UpdateTick!");
			return;
		}
		...
		if ((((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), MeltingSoftBasalt3Block.block.getDefaultState(), 3);
		} else if (((new Object() {
			public double getValue(IWorld world, BlockPos pos, String tag) {
				TileEntity tileEntity = world.getTileEntity(pos);
				if (tileEntity != null)
