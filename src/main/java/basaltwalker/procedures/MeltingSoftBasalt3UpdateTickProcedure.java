...
public class MeltingSoftBasalt3UpdateTickProcedure extends BasaltWalkerModElements.ModElement {
	public MeltingSoftBasalt3UpdateTickProcedure(BasaltWalkerModElements instance) {
		super(instance, 10);
	}
