...
public class SoftBasaltUpdateTickProcedure extends BasaltWalkerModElements.ModElement {
	public SoftBasaltUpdateTickProcedure(BasaltWalkerModElements instance) {
		super(instance, 7);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), MeltingSoftBasalt1Block.block.getDefaultState(), 3);
		} else if (((new Object() {
			public double getValue(IWorld world, BlockPos pos, String tag) {
				TileEntity tileEntity = world.getTileEntity(pos);
				if (tileEntity != null)
