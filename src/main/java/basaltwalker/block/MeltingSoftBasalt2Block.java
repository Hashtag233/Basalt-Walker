...
public class MeltingSoftBasalt2Block extends BasaltWalkerModElements.ModElement {
	@ObjectHolder("basalt_walker:melting_soft_basalt_2")
	public static final Block block = null;
	@ObjectHolder("basalt_walker:melting_soft_basalt_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public MeltingSoftBasalt2Block(BasaltWalkerModElements instance) {
		super(instance, 5);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("melting_soft_basalt_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("melting_soft_basalt_2");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MeltingSoftBasalt2UpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("melting_soft_basalt_2");
		}
