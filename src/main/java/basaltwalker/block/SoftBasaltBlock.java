...
public class SoftBasaltBlock extends BasaltWalkerModElements.ModElement {
	@ObjectHolder("basalt_walker:soft_basalt")
	public static final Block block = null;
	@ObjectHolder("basalt_walker:soft_basalt")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SoftBasaltBlock(BasaltWalkerModElements instance) {
		super(instance, 3);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("soft_basalt"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SoftBasaltUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("soft_basalt");
		}
